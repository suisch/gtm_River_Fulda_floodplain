...
read_parameters<- function(run){
  ...
  recharge_fraction_of_precipitation <- parvar$recharge_fraction_of_precipitation[run]
  ...
  #gives NULL , is not used - can be deleted ?! Detritus_COD_mol_L_precipitation = parvar$Detritus_COD_mol_L_precipitation[run]
