...
plot_convergence_gtm <- function(n, est, estl = NULL, estu = NULL, ex = NULL, labels = NULL, ylim =  NULL, col = 1:M, lty = 1:(M-1),  ...){
	...
	legend('bottom', legend = colnames(est), lty = lty, col = col, bg = 'white', lwd = 2)
